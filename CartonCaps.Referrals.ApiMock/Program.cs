...
using (var scope = app.Services.CreateScope())
{
    ...
    db.ReferralLinks.Add(await ReferralsApiDataMock.GetReferalLinkInitialData(scope.ServiceProvider.GetRequiredService<ILinkVendorClient>()));
    db.Referrals.AddRange(ReferralsApiDataMock.GetReferalsInitialData());
    db.SaveChanges();
}
